...
<a href="science-student-feedback11" class="btn btn-primary btn-md  active" role="button" aria-pressed="true">Science</a>
    ...
    <br>
    <br>
    <a href="science-student-feedback11" class="btn btn-primary btn-md  " role="button" aria-pressed="true">11th</a>
    <a href="science-student-feedback12" class="btn btn-primary btn-md active " role="button" aria-pressed="true">12th</a>
                ...
                <table class="table">
                    ...
                    <tbody>
                        <?php
                          ...
                          $science_feedback= getByData("Science","12th");
                          if(mysqli_num_rows($science_feedback)>0)
                          {
                            foreach($science_feedback as $item)
                            {
                                ?>
                                    <tr>
    ...
    <div class="btn-group pull-right">  
      <form action="code/code" method="post">          
        <button type="submit" id="export_data" name='export_data2' value="Export to excel" class="btn btn-info">Export to excel</button>
      </form>
    </div>
  </div>
    </div>
