            ...
            <div class="card-body">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        if (isset($_GET['id'])) {
                            $id = $_GET['id'];
                            $view_faculty = getByID("science", $id);
                                            ...
                                            <div class="container-fluid">
                                                <div class="card">
                                                    <div class="card-body">
                                                        ...
                                                        <img src="uploads/science_faculty/<?= $data['image'] ?>" alt="">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>

                                        <button type="submit" class="btn btn-primary" name="update-faculty-science">Submit</button>
                                </form>
