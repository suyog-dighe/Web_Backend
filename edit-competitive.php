...
<div class="container-fluid">
    <div class="container-fluid">
        <div class="card">
            <div class="card-body">
                <h5 class="card-title fw-semibold mb-4">Edit Faculty </h5>
                <div class="card">
                    <div class="card-body">
                        <?php
                        ...
                        if (isset($_GET['id'])) {
                            $id = $_GET['id'];
                            $view_faculty = getByID("competative", $id);
                                            ...
                                            <div class="container-fluid">
                                                <div class="card">
                                                    <div class="card-body">
                                                        ...
                                                        <img src="uploads/competative_faculty/<?= $data['image'] ?>" alt="">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>

                                        <button type="submit" class="btn btn-primary" name="update-faculty-competative">Submit</button>
                                </form>
