...
<div class="container-fluid">
    ...
    <a href="competative-faculty" class="btn btn-primary btn-md active " role="button"
        aria-pressed="true">Competitive</a>
    <br>
    <h5 class="card-title fw-semibold mb-4"><br>Competitive Department Faculties</h5>
    <br>
    <div class="container-fluid">
        <div class="card">
                ...
                <div class="table-responsive table-dark">
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            $competative = getAll("competative");
                            if (mysqli_num_rows($competative) > 0) {
                                foreach ($competative as $item) {
                                    ?>
                                    <tr>
                                        ...
                                        <td scope="col-md-5"><img class="img"
                                                src="<?php echo "uploads/competative_faculty/" . $item['image']; ?>"
                                                style="width: 200px; height: 200px;"></td>
                                        <td scope="col-md-4"><a href="edit-competitive?id=<?= $item['id']; ?>"
                                        ...
                                        <td scope="col-md-4">
                                            <form action="code/code" method="POST"><input type="hidden" name="faculty_id"
                                                    ...
                                                    name="delete_faculty_btn_competative">Delete</button></form>
                                        </td>
                                    </tr>
